...
daqdataStreams2 = ['IceTopSTA3_13','IceTopSTA5_13','IceTop_InFill_STA3_13','InIceSMT_IceTopCoincidence_13','HighQFilter_17','FilterMinBias_13','HESEFilter_15']
frtStream = 'FixedRateFilter_13'
sdstStreams = filter_globals.sdst_streams

filelist = glob.glob('/scratch/blaufuss/data/2020_testrun/PFFilt_PhysicsFiltering_Run00134065_Subrun00000000_000000[0-1]*')
...
#day_frac = 35.655        # Run121585_0-19
#day_frac = 44.94        # Run121585_0-19
#day_frac = 49.14        # Run121585_0-19 - spe
#day_frac = 47.70        # Run121585_0-19 - 2017
#day_frac = 49.10       # Run121585_0-19 - 2019
#day_frac = 31.12       # Run132765_0-19 - 2019
day_frac = 37.13       # Run134065_0-19 - 2020 (2326.86 s)


gzip_frac = 10.99   #12.00     ## <- just the "filter extras", recos, FilterMasks, etc, derated a bit
                       ## since I measured them in isolation and bzip2 optimal there
dst_gzip_frac = 3.15   #3.42 ## factor applies to 4 SuperDST objects, right now with I3EventHeader and SuperDST
daq_gzip_frac = 1.40   #1.53 ## compression ratio of I3DAQData+I3DAQDataTrimmed
...
dst_keys = (filter_globals.smalltriggerhierarchy,
            ...
            'I3DST_InIceSplit0') ##since it gets remapped from filter_globals.dstreco
